...
def main() -> None:
    ...
    run(
        python, "openpi_droid_smoke.py", "--mock", "--calls", "8",
    ...
    run(
        ...
        "OpenPI π0.5-DROID client Mock（非神经推理）、Dex1 指尖/抓持、5 档 Gate-A.2 EEF/Joint 安全调速、168 个唯一 target 的 phase-aware preflight、"
