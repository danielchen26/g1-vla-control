...
<nav class="tabs" aria-label="报告页面"><button class="tab-btn active" data-tab="overview">执行摘要</button><button class="tab-btn" data-tab="workflow">下一步路线</button><button class="tab-btn" data-tab="deep">深度验证</button><button class="tab-btn" data-tab="retiming">调速所需信息</button><button class="tab-btn" data-tab="requirements">模型与接入</button><button class="tab-btn" data-tab="evidence">证据与历史</button></nav>
